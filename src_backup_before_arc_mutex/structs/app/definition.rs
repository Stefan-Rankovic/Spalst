...
use crate::{
    ...
    enums::{AchievementId, MainMenuEnum, ManagePlaythroughsMenu, MenuElementsMainMenuSelected},
    structs::{
        Account, AchievementQueue, Data, Game, MainMenu, Menu, MenuElementEmpty,
        MenuElementsMainMenu,
    },
    traits::{LoadableSafe, MenuElements, Saveable},
    utils::create_block,
};
...
pub struct App {
    ...
    #[deprecated = "Uses old MainMenu system."]
    menu_old: Option<MainMenu>,
    pub menu: Menu,
...
impl App {
    pub async fn try_new() -> Result<Self> {
        ...
        Ok(Self {
            path: path.clone(),
            menu_old: None,
            menu: Menu::new(MenuElementEmpty),
...
impl App {
    ...
    pub async fn run(&mut self, mut terminal: DefaultTerminal) -> Result<()> {
            ...
            .downcast_ref::<MenuElementsMainMenu>()
        {
            ...
            match main_menu
                .selected_element()
                .wrap_err_with(|| "No selected element in main menu.")?
            {
