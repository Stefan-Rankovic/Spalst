...
use crate::consts::{DOWN_KEYS, LEFT_KEYS, RIGHT_KEYS, UP_KEYS};
...
pub trait MenuElementsSelectedEnum: Copy + Debug + IntoDiscriminant
// todo: figure out if the following lines are necessary.
